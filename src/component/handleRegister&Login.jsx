...
export const HandleLogin = (error,setError,userLog,setUserLog,users,setAuth,navigate) => {
...
export const handleRegister = ( setError, setAuth, navigate, formdata, setUsers) => {
